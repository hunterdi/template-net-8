...
namespace Infrastructure.Behaviors.Extensions
{
    public static class QueryExtensions
    {
        ...
        public static async Task<PagedResponse<TEntity>> PagingAsync<TEntity, TKey>(this IQueryable<TEntity> query, int pageSize = 10, int pageNumber = 1, CancellationToken cancellationToken = default) where TEntity : BaseEntity<TKey> where TKey : IComparable
        {
            ...
            return new PagedResponse<TEntity>(result, totalRecords, pageNumber, pageSize);
        }
    }
}
